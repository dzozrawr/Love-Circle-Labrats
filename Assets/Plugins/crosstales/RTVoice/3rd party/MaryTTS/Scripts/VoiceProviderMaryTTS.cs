...
namespace Crosstales.RTVoice.MaryTTS
{
   ...
   [HelpURL("https://www.crosstales.com/media/data/assets/rtvoice/api/class_crosstales_1_1_r_t_voice_1_1_google_1_1_voice_provider_google.html")] //TODO update
   //[ExecuteInEditMode]
...
*/
      ...
      private void Awake()
      {
         ...
         port = 443;
         username = "rtvdemo"; //TODO change user in the next release
         password = APIKeys.MaryTTS;
         type = Model.Enum.MaryTTSType.RAWMARYXML;
      }
#endif
